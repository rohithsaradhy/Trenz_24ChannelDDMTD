...
set genomeRtd $env(RT_TMP)/35C71BA8.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {sc_mmu_v1_0_8_top__GC0}]"
...
set genomeName [subst -nocommands -novariables {sc_mmu_v1_0_8_top__GC0}]
