...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000082000000} \
   ...
   CONFIG.SEG002_SIZE {15} \
   CONFIG.SEG002_SUPPORTS_READ {1} \
   CONFIG.SEG002_SUPPORTS_WRITE {1} \
   CONFIG.SEG003_BASE_ADDR {0x0000000084000000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC001_RDATA_WIDTH {256} \
   CONFIG.MSC001_WDATA_WIDTH {256} \
   CONFIG.MSC002_RDATA_WIDTH {32} \
   CONFIG.MSC002_WDATA_WIDTH {32} \
   CONFIG.MSC003_RDATA_WIDTH {256} \
   CONFIG.MSC003_WDATA_WIDTH {256} \
   CONFIG.NUM_MSC {4} \
   CONFIG.NUM_READ_OUTSTANDING {8} \
   ...
   CONFIG.SEP002_RDATA_WIDTH {256} \
   CONFIG.SEP002_WDATA_WIDTH {256} \
   CONFIG.SEP003_PROTOCOL {AXI4} \
   CONFIG.SEP003_RDATA_WIDTH {256} \
   CONFIG.SEP003_WDATA_WIDTH {256} \
   CONFIG.SUPPORTS_NARROW {1} \
