...
-- Date        : Thu Aug 27 11:44:21 2020
-- Host        : rsaradhy-acer running 64-bit Ubuntu 18.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/rsaradhy/Work/trenz/vivado/project_1/project_1.srcs/sources_1/ip/clock_pll/clock_pll_sim_netlist.vhdl
-- Design      : clock_pll
...
entity clock_pll_clock_pll_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clock_pll_clock_pll_clk_wiz : entity is "clock_pll_clk_wiz";
end clock_pll_clock_pll_clk_wiz;

architecture STRUCTURE of clock_pll_clock_pll_clk_wiz is
...
entity clock_pll is
  ...
  attribute NotValidForBitStream of clock_pll : entity is true;
end clock_pll;

architecture STRUCTURE of clock_pll is
begin
inst: entity work.clock_pll_clock_pll_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
