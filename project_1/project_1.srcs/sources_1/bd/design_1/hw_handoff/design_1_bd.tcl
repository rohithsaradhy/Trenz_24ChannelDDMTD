...
proc create_root_design { parentCell } {
  ...
  set CLK_IN [ create_bd_port -dir I -type clk -freq_hz 320000000 CLK_IN ]
  ...
  set TDATA [ create_bd_port -dir I -from 63 -to 0 -type data TDATA ]
  set TLAST [ create_bd_port -dir I TLAST ]
  set TREADY [ create_bd_port -dir O TREADY ]
  set TSTRB [ create_bd_port -dir I -from 7 -to 0 -type data TSTRB ]
  ...
  connect_bd_intf_net -intf_net data_transfer_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins data_transfer_0/M_AXIS]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_ports RST] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins data_transfer_0/m_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports CLK_IN] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins data_transfer_0/m_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
