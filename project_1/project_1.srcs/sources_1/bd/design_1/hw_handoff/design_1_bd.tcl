...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {400.000000} \
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports CLK_400] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
