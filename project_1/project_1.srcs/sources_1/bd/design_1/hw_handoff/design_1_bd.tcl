...
proc create_root_design { parentCell } {
  ...
  set TDATA [ create_bd_port -dir I -from 1023 -to 0 -type data TDATA ]
  set TLAST [ create_bd_port -dir I TLAST ]
  set TREADY [ create_bd_port -dir O TREADY ]
  set TSTRB [ create_bd_port -dir I -from 127 -to 0 -type data TSTRB ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_M_AXIS_TDATA_WIDTH {1024} \
 ] $data_transfer_0
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports CLK] [get_bd_ports CLK_IN] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins data_transfer_0/m_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
